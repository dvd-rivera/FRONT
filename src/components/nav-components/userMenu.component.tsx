...
const UserMenu: React.FC = () => {
    ...
    const buttonUserMenu = 'transition-all hidden lg:flex p-3 rounded'

    if (!userStatus) {
        return (
            <div className="login-container mx-4 transition hover:bg-slate-100 px-4 rounded-md my-1 lg:my-0 lg:w-auto w-full lg:text-left text-center py-3 order-1 lg:order-last">
